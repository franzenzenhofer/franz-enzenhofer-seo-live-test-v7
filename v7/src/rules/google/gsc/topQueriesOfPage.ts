...
export const gscTopQueriesOfPageRule: Rule = {
  ...
  async run(page, ctx) {
    ...
    const body = { startDate: '2020-01-01', endDate: '2099-12-31', dimensions: ['query','page'], dimensionFilterGroups: [{ groupType: 'and', filters: [{ dimension: 'page', operator: 'equals', expression: page.url }] }], rowLimit: 25 }
    try {
