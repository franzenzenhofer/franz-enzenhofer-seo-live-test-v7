...
export const gscDirectoryWorldwideRule: Rule = {
  ...
  async run(page, ctx) {
    ...
    return { label: 'GSC', message: `Directory impressions ${imp}`, type: 'info', name: NAME, details: { url: page.url, property, propertyType, directory: dir, impressions: imp, apiResponse: j } }
  },
}
