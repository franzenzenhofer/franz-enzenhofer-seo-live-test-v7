...
const TESTED = 'Normalized visible body text and tallied the five most frequent words (length ≥ 4).'
...
export const topWordsRule: Rule = {
  ...
  async run(page) {
    ...
    if (!t) {
      return { label: 'DOM', message: 'No text', type: 'info', name: 'Top words', details: { tested: TESTED, reference: SPEC } }
    }
    ...
    return {
      ...
      type: 'info',
      name: 'Top words',
      details: { topWords: Object.fromEntries(topFreq), tested: TESTED, reference: SPEC },
    }
  },
}
